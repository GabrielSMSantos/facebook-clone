import '../../css/header/leftSideHeader.css';
...
export function LeftSideHeader() {
    ...
    return (
        <>
            <a href="/">
                <svg viewBox="0 0 36 36" fill="url(#jsc_c_3)" height="40" width="40">
                    <defs>
            ...
            <div id="divSearch">
                <input id="inputSearch" type="text" placeholder="Pesquisar no Facebook"/>
                <img id="iconSearch" src="../media/icons/iconSearch.png" height="17"/>
            </div>
